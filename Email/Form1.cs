    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                clientDetails.Port = Convert.ToInt32(textBox3.Text.Trim());
                clientDetails.Host = textBox2.Text.Trim();
                clientDetails.EnableSsl = checkBox1.Checked;
                clientDetails.DeliveryMethod = SmtpDeliveryMethod.Network;
                clientDetails.UseDefaultCredentials = false;
                clientDetails.Credentials = new NetworkCredential(textBox6.Text.Trim(), textBox1.Text.Trim());
                MailMessage mailDetails = new MailMessage();
                mailDetails.From = new MailAddress(textBox6.Text.Trim());
